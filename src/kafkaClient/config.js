const kafkaHost = process.env.KAFKA_HOST || "tnd-ms-kafka.dev4.assn.restest.nbn-aws.local:9092";
const sessionTimeOut = process.env.KAFKA_REQUEST_TIME_OUT || 30000;
const consumerGroup = process.env.CONSUMER_GROUP || 'br-get-test-transformer-output-topic';
